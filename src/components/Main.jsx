    ...
    return (
      <main className='flexContainer'>
        <div className='formClass'>
          <form onSubmit={props.handlePictureChange} className='formBlock'>
            <input type="text" name="field" id="field" placeholder='Enter City'/>
            <button type='submit' onClick={changeStyle}><AiOutlineSearch size="25px" color='white' /></button>
